...
function create() {
    ...
    sprite = game.add.sprite(700, 100, 'cupid');
...
function preload() {
    ...
    game.load.image('bullet', 'assets/sprite/arrow.png');
    game.load.image('enemyBullet', 'assets/sprites/arrow.png');
    game.load.spritesheet('invader', 'assets/sprites/heartsheet.png', 32, 32);
    game.load.image('ship', 'assets/sprites/cupid.png');
    game.load.spritesheet('kaboom', 'assets/sprites/heartsheet.png', 128, 128);
